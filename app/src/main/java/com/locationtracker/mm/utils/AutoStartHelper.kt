...
class AutoStartHelper {
    ...
    private val PACKAGE_REDMI_MAIN = "com.miui.securitycenter"
    private val PACKAGE_REDMI_COMPONENT = "com.miui.permcenter.autostart.AutoStartManagementActivity"

    /**
     * POCO
     */
    private val BRAND_POCO = "poco"
    private val PACKAGE_POCO_MAIN = "com.miui.securitycenter"
    private val PACKAGE_POCO_COMPONENT = "com.miui.permcenter.autostart.AutoStartManagementActivity"
    ...
    private fun autoStartAsus(context: Context) {
        if (isPackageExists(context, PACKAGE_ASUS_MAIN)) {
            showAlert(context) { dialog: DialogInterface, _: Int ->
                try {
                    PrefsUtils().setBooleanPreference(context, PrefsUtils().PREF_KEY_APP_AUTO_START, true)
